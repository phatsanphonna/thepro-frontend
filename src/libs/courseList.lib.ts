export const courseList = {
  kids: [
    ...
    },
    {
      ...
      price: ['2,499 บาท/เดือน', 'ลงแยกวิชาละ 1,300 บาท/เดือน'],
      subjects: [
        {
          name: 'คณิตศาสตร์',
          time: ['เรียนสัปดาห์ละ 5-6 ชั่วโมง', '(สามารถแบ่งชั่วโมงเรียนได้ 1 หรือ 2 วัน/สัปดาห์)']
        },
        {
          name: 'ภาษาอังกฤษ',
  ...
  teen: [
    ...
    {
      name: 'ติวเตรียมเข้า ม.4 (คณิตศาสตร์)',
      subject: 'คณิตศาสตร์',
    ...
    {
      name: 'ติวเตรียมเข้า ม.4 (วิทยาศาสตร์)',
      subject: 'วิทยาศาสตร์',
      time: 'เรียน 1 วัน/สัปดาห์ (วันละ 3 ชั่วโมง)',
      grade: [
        {
    ...
    {
      name: 'ติวเตรียมเข้า ม.4 (ภาษาอังกฤษ)',
      subject: 'ภาษาอังกฤษ',
      time: 'เรียน 1 วัน/สัปดาห์ (วันละ 3 ชั่วโมง)',
      grade: [
        {
